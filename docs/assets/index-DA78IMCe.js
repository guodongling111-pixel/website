...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ll(e,t,n){let r=new Float32Array(Yc),i=new W(0,1,0);return new Hs({name:`SphericalGaussianBlur`,defines:{n:Yc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:fl(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ul(){return new Hs({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:fl(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function dl(){return new Hs({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fl(),fragmentShader:`
	...
	`}var pl=class extends ta{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ks([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Fu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Iu(e,t){let n=Fu[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Lu=new W;function Ru(){return K.getLuminanceCoefficients(Lu),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Lu.x.toFixed(4)}, ${Lu.y.toFixed(4)}, ${Lu.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`;class d{constructor(e){this.props=e||{},this.uniforms=this.props.material?.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new Va,this.camera=new dc,this.uniforms&&(this.material=new Us(this.props.material),this.geometry=new Ps(2,2),this.plane=new is(this.geometry,this.material),this.scene.add(this.plane))}update(){i.renderer.setRenderTarget(this.props.output||null),i.renderer.render(this.scene,this.camera),i.renderer.setRenderTarget(null)}}class f extends d{constructor(e){super({material:{vertexShader:c,fragmentShader:l,uniforms:{boundarySpace:{value:e.cellScale},px:{value:e.cellScale},fboSize:{value:e.fboSize},velocity:{value:e.src.texture},dt:{value:e.dt},isBFECC:{value:!0}}},output:e.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){let e=new Fo,t=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);e.setAttribute(`position`,new bo(t,3)),this.line=new Os(e,new Us({vertexShader:`
  attribute vec3 position;
  uniform vec2 px;
  precision highp float;
  varying vec2 uv;
...
`,fragmentShader:l,uniforms:this.uniforms})),this.scene.add(this.line)}update({dt:e,isBounce:t,BFECC:n}){this.uniforms.dt.value=e,this.line.visible=t,this.uniforms.isBFECC.value=n,super.update()}}class _ extends d{constructor(e){super({output:e.dst}),this.init(e)}init(e){super.init(),this.mouse=new is(new Ps(1,1),new Us({vertexShader:`
    precision highp float;
    attribute vec3 position;
    attribute vec2 uv;
    uniform vec2 center;
...
`,blending:2,depthWrite:!1,uniforms:{px:{value:e.cellScale},force:{value:new U(0,0)},center:{value:new U(0,0)},scale:{value:new U(e.cursor_size,e.cursor_size)}}})),this.scene.add(this.mouse)}update(e){let t=o.diff.x/2*e.mouse_force,n=o.diff.y/2*e.mouse_force,r=e.cursor_size*e.cellScale.x,i=e.cursor_size*e.cellScale.y,a=Math.min(Math.max(o.coords.x,-1+r+e.cellScale.x*2),1-r-e.cellScale.x*2),s=Math.min(Math.max(o.coords.y,-1+i+e.cellScale.y*2),1-i-e.cellScale.y*2),c=this.mouse.material.uniforms;c.force.value.set(t,n),c.center.value.set(a,s),c.scale.value.set(e.cursor_size,e.cursor_size),super.update()}}class D extends d{constructor(e){super({material:{vertexShader:c,fragmentShader:`
    precision highp float;
    uniform sampler2D velocity;
...
`,uniforms:{boundarySpace:{value:e.boundarySpace},velocity:{value:e.src.texture},px:{value:e.cellScale},dt:{value:e.dt}}},output:e.dst}),this.init()}update({vel:e}){this.uniforms.velocity.value=e.texture,super.update()}}class ee extends d{constructor(e){super({material:{vertexShader:c,fragmentShader:`
    precision highp float;
...
`,uniforms:{boundarySpace:{value:e.boundarySpace},pressure:{value:e.src_p.texture},velocity:{value:e.src_v.texture},px:{value:e.cellScale},dt:{value:e.dt}}},output:e.dst}),this.init()}update({vel:e,pressure:t}){this.uniforms.velocity.value=e.texture,this.uniforms.pressure.value=t.texture,super.update()}}class A{constructor(e){this.options={iterations_poisson:32,iterations_viscous:32,mouse_force:20,resolution:.5,cursor_size:100,viscous:30,isBounce:!1,dt:.014,isViscous:!1,BFECC:!0,...e},this.fbos={vel_0:null,vel_1:null,vel_viscous0:null,vel_viscous1:null,div:null,pressure_0:null,pressure_1:null},this.fboSize=new U,this.cellScale=new U,this.boundarySpace=new U,this.init()}init(){this.calcSize(),this.createAllFBO(),this.createShaderPass()}getFloatType(){return/(iPad|iPhone|iPod)/i.test(navigator.userAgent)?rr:nr}createAllFBO(){let e={type:this.getFloatType(),depthBuffer:!1,stencilBuffer:!1,minFilter:qn,magFilter:qn,wrapS:Hn,wrapT:Hn};for(let t in this.fbos)this.fbos[t]=new ta(this.fboSize.x,this.fboSize.y,e)}createShaderPass(){this.advection=new f({cellScale:this.cellScale,fboSize:this.fboSize,dt:this.options.dt,src:this.fbos.vel_0,dst:this.fbos.vel_1}),this.externalForce=new _({cellScale:this.cellScale,cursor_size:this.options.cursor_size,dst:this.fbos.vel_1}),this.viscous=new D({cellScale:this.cellScale,boundarySpace:this.boundarySpace,viscous:this.options.viscous,src:this.fbos.vel_1,dst:this.fbos.vel_viscous1,dst_:this.fbos.vel_viscous0,dt:this.options.dt}),this.divergence=new O({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.vel_viscous0,dst:this.fbos.div,dt:this.options.dt}),this.poisson=new ee({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.div,dst:this.fbos.pressure_1,dst_:this.fbos.pressure_0}),this.pressure=new k({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src_p:this.fbos.pressure_0,src_v:this.fbos.vel_viscous0,dst:this.fbos.vel_0,dt:this.options.dt})}calcSize(){let e=Math.max(1,Math.round(this.options.resolution*i.width)),t=Math.max(1,Math.round(this.options.resolution*i.height)),n=1/e,r=1/t;this.cellScale.set(n,r),this.fboSize.set(e,t)}resize(){this.calcSize();for(let e in this.fbos)this.fbos[e].setSize(this.fboSize.x,this.fboSize.y)}update(){this.options.isBounce?this.boundarySpace.set(0,0):this.boundarySpace.copy(this.cellScale),this.advection.update({dt:this.options.dt,isBounce:this.options.isBounce,BFECC:this.options.BFECC}),this.externalForce.update({cursor_size:this.options.cursor_size,mouse_force:this.options.mouse_force,cellScale:this.cellScale});let e=this.fbos.vel_1;this.options.isViscous&&(e=this.viscous.update({viscous:this.options.viscous,iterations:this.options.iterations_viscous,dt:this.options.dt})),this.divergence.update({vel:e});let t=this.poisson.update({iterations:this.options.iterations_poisson});this.pressure.update({vel:e,pressure:t})}}class j{constructor(){this.init()}init(){this.simulation=new A,this.scene=new Va,this.camera=new dc,this.output=new is(new Ps(2,2),new Us({vertexShader:c,fragmentShader:`
    precision highp float;
    uniform sampler2D velocity;
...
`,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new U},palette:{value:t},bgColor:{value:n}}})),this.scene.add(this.output)}addScene(e){this.scene.add(e)}resize(){this.simulation.resize()}render(){i.renderer.setRenderTarget(null),i.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class te{constructor(e){this.props=e,i.init(e.$wrapper),o.init(e.$wrapper),o.autoIntensity=e.autoIntensity,o.takeoverDuration=e.takeoverDuration,this.lastUserInteraction=performance.now(),o.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new s(o,this,{enabled:e.autoDemo,speed:e.autoSpeed,resumeDelay:e.autoResumeDelay,rampDuration:e.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener(`resize`,this._resize)}init(){this.output=new j,this.props.$wrapper.appendChild(i.renderer.domElement)}resize(){i.resize(),this.output.resize()}loop(){T.current&&(C.current=requestAnimationFrame(this._loop),this.autoDriver&&this.autoDriver.update(),o.update(),i.update(),this.output.update())}pause(){C.current&&cancelAnimationFrame(C.current)}destroy(){if(window.removeEventListener(`resize`,this._resize),this.pause(),o.dispose(),i.renderer){i.renderer.dispose();let e=i.renderer.domElement;e&&e.parentNode&&e.parentNode.removeChild(e)}}}let ne=new te({$wrapper:b.current,autoDemo:p,autoSpeed:m,autoIntensity:h,autoResumeDelay:v,autoRampDuration:y,takeoverDuration:g});return ne.loop(),x.current=ne,S.current=new ResizeObserver(()=>{E.current&&cancelAnimationFrame(E.current),E.current=requestAnimationFrame(()=>ne.resize())}),S.current.observe(b.current),w.current=new IntersectionObserver(([e])=>{T.current=e.isIntersecting,T.current?ne.loop():ne.pause()}),w.current.observe(b.current),()=>{x.current&&x.current.destroy(),S.current&&S.current.disconnect(),w.current&&w.current.disconnect(),E.current&&cancelAnimationFrame(E.current)}},[p,m,h,v,y,g,u,e,t,c,r,i,a,o,s,l,n]),(0,z.jsx)(`div`,{className:`background-effect-wrapper ${f}`,style:d,children:(0,z.jsx)(`div`,{ref:b,className:`liquid-ether-container`})})}var Jd=[{id:`itinerary`,title:`行程生成与编辑系统`,description:`基于用户输入自动生成多日结构化行程，并通过"点击选择"方式从海量内容中筛选景点，支持用户对结果进行自由编辑与调整，实现高效与灵活的平衡。`,modes:[{title:`标准行程模式`,items:[{type:`video`,src:`itinerary-main.mp4`},{type:`image`,src:`itinerary-main1.png`},{type:`image`,src:`itinerary-mian2.png`}]},{title:`休息日模式`,items:[{type:`video`,src:`itinerary-rest.mp4`},{type:`image`,src:`itinerary-rest1.png`},{type:`image`,src:`itinerary-rest2.png`}]}]},{id:`poi-filter`,title:`标签化分类系统`,description:`围绕"出片与在地体验"构建结构化标签体系，通过文艺/小众/拍照等标签帮助用户快速筛选高价值兴趣点，降低决策成本，提升选择效率。`,items:[{type:`video`,src:`tag.mp4`},{type:`image`,src:`tag1.png`},{type:`image`,src:`tag2.png`}]},{id:`food`,title:`餐饮融合系统`,description:`基于年轻用户"低强度、松弛感旅行"的行为特征，将餐厅与外卖选项嵌入行程时间轴，支持晚出发、酒店休息等灵活场景。`,items:[{type:`video`,src:`food.mp4`},{type:`image`,src:`food1.png`},{type:`image`,src:`food2.png`}]},{id:`import`,title:`内容导入系统`,description:`支持小红书链接解析，将非结构化攻略内容转化为可选择的行程节点，提升信息利用效率。`,items:[{type:`video`,src:`intro.mp4`},{type:`image`,src:`intro1.png`},{type:`image`,src:`intro2.png`}]}],Yd=[{id:`artemis`,title:`RouterCrafter`,subtitle:`智能旅行行程规划工具`,description:`解决旅行规划信息过载问题的地图驱动型行程生成工具，通过空间路径优化与结构化行程设计，帮助用户高效完成旅行规划。`,fullDescription:`RouterCrafter是一款面向自由行用户的智能行程规划工具，致力于解决旅行信息分散、规划效率低和路线不合理的问题。通过地图驱动的路径优化与结构化行程设计，帮助用户从海量攻略中快速生成清晰、可执行的旅行路线。`,background:{problem:`自由行用户（尤其是年轻女性与Citywalk人群）在旅行规划中面临信息过载问题，需要在小红书、抖音等多个平台反复筛选攻略，信息碎片化严重。同时行程规划过程复杂，需要兼顾路线合理性、时间安排与餐饮选择，整体效率较低。`,goal:`构建一个以地图为核心的智能行程规划系统，通过结构化信息与路径优化算法，帮助用户快速生成高质量旅行路线，并具备可扩展为真实产品的能力。`},features:Jd,tech:[`React`,`Leaflet`,`Python`,`Vercel`],highlights:[`基于地理距离的路线优化，减少路径折返`,`将内容平台信息转化为结构化数据（小红书导入）`,`行程时间结构化设计（上午 / 下午 / 晚上）`,`地图、内容与行程规划的融合型产品设计`,`围绕"出片与在地文化体验"构建产品核心价值，区别于传统效率导向的旅行工具`],links:{github:`https://github.com/guodongling111-pixel`,demo:`https://tourism-app-teal.vercel.app/`}}],Xd={name:`郭冬玲`,role:`产品实习生`,intro:`具备产品思维与数据理解能力，擅长从用户需求出发，将复杂问题拆解为清晰可执行的产品方案`,background:{education:`英语 + 国际贸易双专业`,certifications:`IELTS 6.5 / TEM-4`,focus:`产品设计 / 前端开发 / 数据应用`},skills:[`产品思维（用户问题拆解与功能设计）`,`前端开发能力（React）`,`地图与空间信息产品（Leaflet）`],interests:[`旅行科技（Travel Tech）`,`地图与空间信息产品`,`AI与数据驱动产品`],email:`1748025085@qq.com`,github:`https://github.com/guodongling111-pixel`,linkedin:`https://linkedin.com`},Zd=`/website/assets/person-Ekn-eBAR.png`;function Qd(){let e=(0,_.useRef)(null),t=tt();return(0,z.jsxs)(`div`,{className:`home-page`,children:[(0,z.jsx)(`section`,{className:`hero-section`,children:(0,z.jsxs)(`div`,{className:`hero-content`,children:[(0,z.jsxs)(`div`,{className:`hero-left`,children:[(0,z.jsx)(`h1`,{className:`hero-name`,children:Xd.name}),(0,z.jsx)(`p`,{className:`hero-title`,children:Xd.role}),(0,z.jsxs)(`div`,{className:`skill-tags`,children:[(0,z.jsx)(`span`,{className:`skill-tag`,children:`产品设计`}),(0,z.jsx)(`span`,{className:`skill-tag`,children:`前端开发`}),(0,z.jsx)(`span`,{className:`skill-tag`,children:`数据应用`})]}),(0,z.jsxs)(`div`,{className:`hero-actions`,children:[(0,z.jsx)(bn,{to:`/projects`,className:`hero-btn`,style:{pointerEvents:`auto`},children:`Explore My Projects`}),(0,z.jsx)(`button`,{onClick:()=>{e.current?.scrollIntoView({behavior:`smooth`})},className:`hero-btn-outline`,style:{pointerEvents:`auto`},children:`↓ Explore`})]}),(0,z.jsxs)(`div`,{className:`hero-contact`,children:[(0,z.jsx)(bn,{to:`/contact`,className:`contact-icon`,title:`联系方式`,style:{pointerEvents:`auto`},children:(0,z.jsx)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:(0,z.jsx)(`path`,{d:`M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z`})})}),(0,z.jsx)(`button`,{className:`contact-icon`,title:`邮箱`,onClick:()=>t(`/contact`),style:{pointerEvents:`auto`,cursor:`pointer`},children:(0,z.jsxs)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:[(0,z.jsx)(`path`,{d:`M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z`}),(0,z.jsx)(`polyline`,{points:`22,6 12,13 2,6`})]})}),(0,z.jsx)(`a`,{href:Xd.github,target:`_blank`,rel:`noopener noreferrer`,className:`contact-icon`,title:`GitHub`,style:{pointerEvents:`auto`},children:(0,z.jsx)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 24 24`,fill:`currentColor`,children:(0,z.jsx)(`path`,{d:`M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z`})})})]})]}),(0,z.jsx)(`div`,{className:`hero-right`,children:(0,z.jsx)(`img`,{src:Zd,alt:`头像`,className:`hero-avatar`})})]})}),(0,z.jsxs)(`section`,{ref:e,className:`content-section`,children:[(0,z.jsx)(`h2`,{children:`Education`}),(0,z.jsxs)(`div`,{className:`education-card`,children:[(0,z.jsx)(`p`,{className:`edu-school`,children:`山东大学`}),(0,z.jsx)(`p`,{className:`edu-title`,children:Xd.background.education}),(0,z.jsx)(`p`,{className:`edu-desc`,children:Xd.background.certifications})]})]}),(0,z.jsxs)(`section`,{className:`content-section`,children:[(0,z.jsx)(`h2`,{children:`Experience`}),(0,z.jsxs)(`div`,{className:`experience-list`,children:[(0,z.jsxs)(`div`,{className:`experience-card`,style:{pointerEvents:`auto`},children:[(0,z.jsx)(`p`,{className:`exp-header`,children:(0,z.jsx)(`strong`,{children:`2025.02 – 2026.01`})}),(0,z.jsx)(`p`,{className:`exp-title`,children:`跨境电商 AI 选品大模型项目（王晓燕）`}),(0,z.jsxs)(`p`,{className:`exp-desc`,children:[`参与 AI 选品产品`,(0,z.jsx)(`strong`,{children:`从数据搭建 → 场景落地`}),`的完整流程，主导模型验证与用户反馈闭环，沉淀选品交互方法论。`]}),(0,z.jsxs)(`ul`,{className:`exp-details`,children:[(0,z.jsxs)(`li`,{children:[(0,z.jsx)(`strong`,{children:`数据与市场分析`}),`：通过 AI 辅助开发 Python + Selenium 爬虫，采集东南亚 TikTok `,(0,z.jsx)(`strong`,{children:`1万+商品数据`}),`并完成结构化处理`]}),(0,z.jsxs)(`li`,{children:[(0,z.jsx)(`strong`,{children:`模型交互设计`}),`：设计"市场分析-品类切入-精准提问"逻辑，组织 `,(0,z.jsx)(`strong`,{children:`300+用户`}),`测试验证模型效果`]}),(0,z.jsxs)(`li`,{children:[(0,z.jsx)(`strong`,{children:`产品迭代优化`}),`：基于实操数据与问卷反馈分析用户痛点，输出优化方案并推动体验提升`]})]})]}),(0,z.jsxs)(`div`,{className:`experience-card`,style:{pointerEvents:`auto`},children:[(0,z.jsx)(`p`,{className:`exp-header`,children:(0,z.jsx)(`strong`,{children:`2023.09 – 2025.06`})}),(0,z.jsx)(`p`,{className:`exp-title`,children:`校学生会社团发展中心 组策部部长`}),(0,z.jsx)(`p`,{className:`exp-desc`,children:`主导校园活动从策划到落地的全流程执行，统筹多方资源实现高效运营与商业转化。`}),(0,z.jsxs)(`ul`,{className:`exp-details`,children:[(0,z.jsxs)(`li`,{children:[`统筹`,(0,z.jsx)(`strong`,{children:`10+校级活动`}),`，联动`,(0,z.jsx)(`strong`,{children:`100+社团 / 60人团队`}),`，覆盖`,(0,z.jsx)(`strong`,{children:`1000+师生`})]}),(0,z.jsxs)(`li`,{children:[`负责内容策划与传播增长，累计触达`,(0,z.jsx)(`strong`,{children:`1500+用户`})]}),(0,z.jsxs)(`li`,{children:[`对接商家资源，单场拉取`,(0,z.jsx)(`strong`,{children:`1万元+赞助`}),`，实现成本覆盖`]}),(0,z.jsx)(`li`,{children:`拆解任务并推进执行，保障项目进度与质量`})]})]}),(0,z.jsxs)(`div`,{className:`experience-card`,style:{pointerEvents:`auto`},children:[(0,z.jsx)(`p`,{className:`exp-title`,children:`AI旅行规划产品（独立开发）`}),(0,z.jsx)(`p`,{className:`exp-desc`,children:`Product Design & Development`}),(0,z.jsx)(`p`,{className:`exp-desc`,children:`从用户需求出发，设计并实现基于地图与行程生成的智能旅行规划工具`})]})]})]})]})}function $d({project:e,isActive:t,onClick:n}){return(0,z.jsxs)(`div`,{className:`project-card ${t?`active`:``}`,onClick:n,children:[(0,z.jsx)(`h3`,{className:`project-title`,children:e.title}),(0,z.jsx)(`p`,{className:`project-subtitle`,children:e.subtitle}),(0,z.jsx)(`p`,{className:`project-description`,children:e.description}),(0,z.jsx)(`div`,{className:`project-tech`,children:e.tech.map(e=>(0,z.jsx)(`span`,{className:`tech-tag`,children:e},e))}),e.id===`artemis`?(0,z.jsx)(bn,{to:`/projects/${e.id}`,className:`project-link`,children:`查看详情 →`}):e.links?.github&&(0,z.jsx)(`a`,{href:e.links.github,target:`_blank`,rel:`noopener noreferrer`,className:`project-link`,children:`GitHub →`})]})}function ef(){let[e,t]=(0,_.useState)(null),n=e=>{t(e),setTimeout(()=>t(null),1e3)};return(0,z.jsxs)(`div`,{className:`projects-page`,children:[(0,z.jsxs)(`div`,{className:`page-header`,children:[(0,z.jsx)(`h1`,{children:`项目作品`}),(0,z.jsx)(`p`,{children:`打造解决问题的工具`})]}),(0,z.jsx)(`div`,{className:`projects-grid`,children:Yd.map(t=>(0,z.jsx)($d,{project:t,isActive:e===t.id,onClick:()=>n(t.id)},t.id))})]})}var tf=`/website/assets/itinerary-main-C1kFbnsf.mp4`,nf=`/website/assets/itinerary-main1-DQgY4K7b.png`,rf=`/website/assets/itinerary-mian2-B35nDzvL.png`,af=`/website/assets/itinerary-rest-DlcOPY1b.mp4`,of=`/website/assets/itinerary-rest1-CuMGY5Fq.png`,sf=`/website/assets/itinerary-rest2-CqmC53SQ.png`,cf=`/website/assets/tag-DcI8fEPN.mp4`,lf=`/website/assets/tag1-BmouJf3C.png`,uf=`/website/assets/tag2-QEbQW2X4.png`,df=`/website/assets/food-C-Pz6sej.mp4`,ff=`/website/assets/food1-Dm-Tvb7B.png`,pf=`/website/assets/food2-Cg-9l4Zq.png`,mf=`/website/assets/intro-RbGaAGds.mp4`,hf=`/website/assets/intro1-2m0zYTDn.png`,gf=`/website/assets/intro2-OMrn1rm_.png`,_f=[`年轻女性（18-35岁）`,`喜欢自由行、Citywalk`,`高频使用小红书、抖音获取攻略`,`注重效率与出片效果`],vf=[`基于**贪心策略的最近邻算法**进行路径优化，按照地理距离由近到远排列景点`,`基于**时间片分配**：每日游玩时长8-10小时，选取3-5个景点，合理分配停留时长`,`**餐饮插入策略**：早餐靠近出发地点、午餐在路线中点、晚餐靠近住宿或返程点`,`综合平衡**路径最优**、**时间合理**与**体验舒适**三个维度`],yf=[`首页 → 输入信息`,`选择景点/导入攻略`,`选择餐饮`,`生成路线`,`行程详情 → 调整行程`],bf={intro:`该项目在开发过程中，我从单纯的功能实现逐步转向对产品体验、信息结构与用户路径的系统性思考。`,sections:[{title:`1. 景点路线规划与地图交互`,points:[`路线规划不仅是距离计算问题，更是**用户体验设计问题**，在设计过程中逐步从"功能实现"转向"体验优化"`],subSections:[{subTitle:`路线设计上：`,subPoints:[`**同区域聚合出发**：强化**同区域景点聚合**，减少跨区跳跃，提升路线连贯性`,`**随机分配到均衡日程**：引入**每日2–3个景点约束**，避免行程过密或过空，使节奏更加稳定`,`**路径生成到体验优化**：加入**时间维度（白天/夜景）**与**路线折返控制**，使整体行程更符合真实旅行体验`]},{subTitle:`实现方式上：`,subPoints:[`采用"先路线逻辑，后地图交互"的**分阶段开发策略**，避免在核心逻辑未稳定时直接引入地图渲染导致系统复杂度上升`]},{subTitle:`交互设计上：`,subPoints:[`以降低**用户认知成本**为目标，简化操作流程，使用户能够更直观理解整体行程结构`]}]},{title:`2. 小红书导入解析模块复盘`,points:[`从**关键词提取**升级为**结构化信息识别**，支持**景点、食物、城市及自定义地点**抽取，并尽量保留未识别信息以减少信息损失`,`从**固定解析**升级为**用户意图驱动解析**，可识别**时间表达（上午/下午/晚上）**与**顺序表达（先/然后/接着）**，并优先保留用户原始结构`,`从**单一输入格式**升级为**多格式解析系统**，支持**自然文本、Day行程结构及箭头路径**等不同输入方式，并适配对应解析逻辑`]},{title:`3. Debug 与 Prompt 驱动开发过程`,points:[`通过**inspect报错 + 截图分析**结合AI辅助定位问题，并按可能性逐步排查，避免盲目修改代码`,`将复杂问题拆解为小步骤逐一验证，并结合清晰的错误上下文，提高调试效率与定位准确性`,`采用**Prompt驱动开发**方式，约束AI仅进行小范围修改并优先分析问题，避免大规模改动导致系统不稳定`]}]};function xf(e){return e.split(/(\*\*[^*]+\*\*)/g).map((e,t)=>e.startsWith(`**`)&&e.endsWith(`**`)?(0,z.jsx)(`strong`,{children:e.slice(2,-2)},t):e)}function Sf({title:e,children:t,isActive:n,onClick:r}){return(0,z.jsxs)(`div`,{className:`info-card ${n?`active`:``}`,onClick:r,children:[(0,z.jsx)(`h3`,{className:`info-card-title`,children:e}),(0,z.jsx)(`div`,{className:`info-card-content`,children:t})]})}function Cf({src:e,onClose:t}){return(0,z.jsxs)(`div`,{className:`image-modal`,onClick:t,children:[(0,z.jsx)(`button`,{className:`image-modal-close`,onClick:t,children:`×`}),(0,z.jsx)(`img`,{src:e,alt:``,onClick:e=>e.stopPropagation()})]})}function wf({feature:e}){let[t,n]=(0,_.useState)(null),r=e=>e===`itinerary-main.mp4`?tf:e===`itinerary-main1.png`?nf:e===`itinerary-mian2.png`?rf:e===`itinerary-rest.mp4`?af:e===`itinerary-rest1.png`?of:e===`itinerary-rest2.png`?sf:e===`tag.mp4`?cf:e===`tag1.png`?lf:e===`tag2.png`?uf:e===`food.mp4`?df:e===`food1.png`?ff:e===`food2.png`?pf:e===`intro.mp4`?mf:e===`intro1.png`?hf:e===`intro2.png`?gf:e;return e.modes?(0,z.jsxs)(`div`,{className:`feature-item`,children:[(0,z.jsx)(`h3`,{className:`feature-title`,children:e.title}),(0,z.jsx)(`p`,{className:`feature-desc`,children:e.description}),(0,z.jsx)(`div`,{className:`mode-list`,children:e.modes.map((e,i)=>(0,z.jsxs)(`div`,{className:`mode-block`,children:[(0,z.jsx)(`h4`,{className:`mode-title`,children:e.title}),(0,z.jsxs)(`div`,{className:`mode-grid`,children:[e.items.map((e,t)=>(0,z.jsx)(`div`,{className:`mode-media`,children:e.type===`video`?(0,z.jsx)(`video`,{src:r(e.src),controls:!0}):(0,z.jsx)(`img`,{src:r(e.src),alt:``,onClick:()=>n(r(e.src))})},t)),t&&(0,z.jsx)(Cf,{src:t,onClose:()=>n(null)})]})]},i))})]}):(0,z.jsxs)(`div`,{className:`feature-item`,children:[(0,z.jsx)(`h3`,{className:`feature-title`,children:e.title}),(0,z.jsx)(`p`,{className:`feature-desc`,children:e.description}),e.items&&(0,z.jsxs)(`div`,{className:`mode-grid`,children:[e.items.map((e,t)=>(0,z.jsx)(`div`,{className:`mode-media`,children:e.type===`video`?(0,z.jsx)(`video`,{src:r(e.src),controls:!0}):(0,z.jsx)(`img`,{src:r(e.src),alt:``,onClick:()=>n(r(e.src))})},t)),t&&(0,z.jsx)(Cf,{src:t,onClose:()=>n(null)})]})]})}function Tf(){let{id:e}=rt(),t=Yd.find(t=>t.id===e),[n,r]=(0,_.useState)(null),i=e=>{r(e),setTimeout(()=>r(null),1e3)};if(!t)return(0,z.jsxs)(`div`,{className:`not-found`,children:[(0,z.jsx)(`h2`,{children:`Project not found`}),(0,z.jsx)(bn,{to:`/projects`,children:`← 返回项目`})]});let a=t.id===`artemis`?Jd:t.features;return(0,z.jsxs)(`div`,{className:`project-detail`,children:[(0,z.jsx)(`div`,{className:`back-link`,children:(0,z.jsx)(bn,{to:`/projects`,children:`← 返回项目`})}),(0,z.jsxs)(`header`,{className:`project-header`,children:[(0,z.jsx)(`h1`,{children:t.title}),(0,z.jsx)(`p`,{className:`project-subtitle`,children:t.subtitle}),(0,z.jsx)(`div`,{className:`project-tech`,children:t.tech.map(e=>(0,z.jsx)(`span`,{className:`tech-tag`,children:e},e))}),t.links?.demo&&(0,z.jsx)(`div`,{className:`project-demo`,children:(0,z.jsxs)(`a`,{href:t.links.demo,target:`_blank`,rel:`noopener noreferrer`,className:`demo-link`,children:[`Live Demo ↗ `,(0,z.jsx)(`span`,{className:`vpn-notice-inline`,children:`* 因引入地图服务（Leaflet），访问网站可能需要科学上网`})]})})]}),t.id===`artemis`&&(0,z.jsxs)(z.Fragment,{children:[t.background&&(0,z.jsx)(`section`,{className:`detail-section`,children:(0,z.jsx)(Sf,{title:`项目背景`,isActive:n===`background`,onClick:()=>i(`background`),children:(0,z.jsxs)(`div`,{className:`bg-grid`,children:[(0,z.jsxs)(`div`,{className:`bg-item`,children:[(0,z.jsx)(`h4`,{children:`用户痛点`}),(0,z.jsxs)(`p`,{children:[`自由行用户（尤其是`,(0,z.jsx)(`strong`,{children:`年轻女性`}),`与Citywalk人群）在旅行规划中面临`,(0,z.jsx)(`strong`,{children:`信息过载`}),`问题，需要在小红书、抖音等多个平台反复筛选攻略，信息呈现`,(0,z.jsx)(`strong`,{children:`高度碎片化`}),`。`]}),(0,z.jsxs)(`p`,{children:[`同时，行程规划过程复杂，需要兼顾路线合理性、时间安排与餐饮选择，整体`,(0,z.jsx)(`strong`,{children:`规划效率较低`}),`。`]})]}),(0,z.jsxs)(`div`,{className:`bg-item`,children:[(0,z.jsx)(`h4`,{children:`产品概述`}),(0,z.jsxs)(`p`,{children:[`构建一个`,(0,z.jsx)(`strong`,{children:`以地图为核心`}),`的智能行程规划系统，通过`,(0,z.jsx)(`strong`,{children:`结构化信息处理`}),`与`,(0,z.jsx)(`strong`,{children:`路径优化算法`}),`，帮助用户快速生成高质量旅行路线，并具备向真实产品落地扩展的能力。`]})]})]})})}),(0,z.jsx)(`section`,{className:`detail-section`,children:(0,z.jsx)(Sf,{title:`目标用户`,isActive:n===`targetUsers`,onClick:()=>i(`targetUsers`),children:(0,z.jsx)(`ul`,{className:`card-list`,children:_f.map((e,t)=>(0,z.jsx)(`li`,{children:e},t))})})}),(0,z.jsxs)(`section`,{className:`detail-section`,children:[(0,z.jsx)(`h2`,{children:`核心功能`}),(0,z.jsx)(`div`,{className:`features-list`,children:a.map(e=>(0,z.jsx)(wf,{feature:e},e.id))})]}),(0,z.jsx)(`section`,{className:`detail-section`,children:(0,z.jsx)(Sf,{title:`核心算法逻辑`,isActive:n===`algorithm`,onClick:()=>i(`algorithm`),children:(0,z.jsx)(`ul`,{className:`card-list`,children:vf.map((e,t)=>(0,z.jsx)(`li`,{children:xf(e)},t))})})}),(0,z.jsx)(`section`,{className:`detail-section`,children:(0,z.jsx)(Sf,{title:`用户流程`,isActive:n===`userFlow`,onClick:()=>i(`userFlow`),children:(0,z.jsx)(`div`,{className:`flow-steps`,children:yf.map((e,t)=>(0,z.jsx)(`span`,{className:`flow-step`,children:e},t))})})}),(0,z.jsx)(`section`,{className:`detail-section`,children:(0,z.jsxs)(Sf,{title:`项目反思与复盘`,isActive:n===`reflection`,onClick:()=>i(`reflection`),children:[(0,z.jsx)(`p`,{className:`reflection-intro`,children:bf.intro}),(0,z.jsx)(`div`,{className:`reflection-sections`,children:bf.sections.map((e,t)=>(0,z.jsxs)(`div`,{className:`reflection-section`,children:[(0,z.jsx)(`h3`,{className:`reflection-title`,children:e.title}),e.points.map((e,t)=>(0,z.jsx)(`p`,{className:`reflection-main-point`,children:xf(e)},t)),e.subSections&&e.subSections.map((e,t)=>(0,z.jsxs)(`div`,{className:`reflection-subsection`,children:[(0,z.jsx)(`p`,{className:`reflection-sub-title`,children:e.subTitle}),(0,z.jsx)(`ul`,{className:`reflection-sub-points`,children:e.subPoints.map((e,t)=>(0,z.jsx)(`li`,{children:xf(e)},t))})]},t))]},t))})]})})]}),t.features&&t.id!==`artemis`&&(0,z.jsxs)(`section`,{className:`detail-section`,children:[(0,z.jsx)(`h2`,{children:`功能特点`}),(0,z.jsx)(`ul`,{className:`feature-list`,children:t.features.map((e,t)=>(0,z.jsx)(`li`,{children:e},t))})]}),(0,z.jsxs)(`section`,{className:`detail-section`,children:[(0,z.jsx)(`h2`,{children:`相关链接`}),(0,z.jsxs)(`div`,{className:`project-links`,children:[t.links?.github&&(0,z.jsx)(`a`,{href:t.links.github,target:`_blank`,rel:`noopener noreferrer`,className:`btn btn-outline`,children:`GitHub`}),t.links?.demo&&(0,z.jsx)(`a`,{href:t.links.demo,target:`_blank`,rel:`noopener noreferrer`,className:`btn btn-primary`,children:`演示地址`})]})]})]})}function Ef(){return(0,z.jsxs)(`div`,{className:`contact-page`,children:[(0,z.jsx)(`h1`,{children:`Contacts`}),(0,z.jsxs)(`div`,{className:`contact-card`,children:[(0,z.jsxs)(`div`,{className:`contact-item`,children:[(0,z.jsx)(`span`,{className:`contact-label`,children:`Phone`}),(0,z.jsx)(`span`,{className:`contact-value`,children:`19819678224`})]}),(0,z.jsxs)(`div`,{className:`contact-item`,children:[(0,z.jsx)(`span`,{className:`contact-label`,children:`Email`}),(0,z.jsx)(`a`,{href:`mailto:${Xd.email}`,className:`contact-link`,children:Xd.email})]}),(0,z.jsxs)(`div`,{className:`contact-item`,children:[(0,z.jsx)(`span`,{className:`contact-label`,children:`GitHub`}),(0,z.jsx)(`a`,{href:Xd.github,target:`_blank`,rel:`noopener noreferrer`,className:`contact-link`,children:`guodongling111-pixel`})]})]})]})}function Df(){return(0,z.jsxs)(_n,{children:[(0,z.jsx)(qd,{colors:[`#E6EFFF`,`#FFE6F8`,`#FFF3E8`],resolution:.4,simResolution:128,style:{position:`fixed`,top:0,left:0,zIndex:-1}}),(0,z.jsx)(Bn,{}),(0,z.jsxs)(kt,{children:[(0,z.jsx)(Dt,{path:`/`,element:(0,z.jsx)(Qd,{})}),(0,z.jsx)(Dt,{path:`/projects`,element:(0,z.jsx)(ef,{})}),(0,z.jsx)(Dt,{path:`/projects/:id`,element:(0,z.jsx)(Tf,{})}),(0,z.jsx)(Dt,{path:`/contact`,element:(0,z.jsx)(Ef,{})})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,z.jsx)(_.StrictMode,{children:(0,z.jsx)(Df,{})}));